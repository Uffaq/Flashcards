...
//         questionBank[i][1]=data.quizlist[i].word;
//         questionBank[i][2]=data.quizlist[i].option_1;
//         questionBank[i][3]=data.quizlist[i].option_2;
//         questionBank[i][4]=data.quizlist[i].option_3;
//       }
...
$.post(
  "/jsonset",
  function(data) {
    console.log(data.quizlist.length);
